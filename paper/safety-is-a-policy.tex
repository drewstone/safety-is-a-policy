...
\paragraph{Reproducibility.} Code, training data, and model weights: \url{https://github.com/drewstone/obliteratus}. All experiments ran on NVIDIA A100-80GB via Modal at a total cost of \$60.
...
\centering
\small
\caption{All 17 experiments with hardware, runtime, and cost.}
\label{tab:cost}
\begin{tabular}{clccc}
\toprule
\textbf{\#} & \textbf{Experiment} & \textbf{GPU} & \textbf{Runtime} & \textbf{Cost} \\
\midrule
1--7 & Abliteration baselines (Track A/B) & A100-80GB & various & $\sim$\$25 \\
8 & QLoRA SFT (Qwen3.5-27B) & A100-80GB & 13 min & \$0.50 \\
9--11 & Track A/B mechanistic probing & A100-80GB & various & $\sim$\$10 \\
12 & Harmfulness probing (both models) & A100-80GB & 20 min & \$0.80 \\
13 & QwQ-32B cross-model & A100-80GB & 2.7 min & \$0.10 \\
14 & Data ablation ($\times$6 parallel) & A100-80GB $\times$6 & 7 min & \$2.70 \\
15 & DeltaNet gate analysis & A100-80GB & 15 min & \$0.60 \\
16 & DeepSeek-R1 cross-family & A100-80GB & 10 min & \$0.40 \\
17 & Multi-turn adversarial & A100-80GB & 25 min & \$1.00 \\
\midrule
& \textbf{Total} & & & $\sim$\textbf{\$60} \\
\bottomrule
\end{tabular}
\end{table}
